...
<div class="page-heading">
                ...
                <form action="{{ url('/assets/add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('assets_model') }}" name="assets_model" placeholder="Enter model">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('assets_specification') }}" name="assets_specification" placeholder="Enter specification">
                                            <span class="text-danger">{{ $errors->first('assets_specification') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    <div class="form-group">
                                            <label for="assets_category_assets_id">Category Assets<span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">   
                                            ...
                                            <input type="text" class="form-control" value="{{ old('assets_type') }}" name="assets_type" required placeholder="Enter type">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="assets_category_id" required>
                                                ...
                                                <option value="{{ $categories->idcategories }}">{{ $categories->categories_code }} {{$categories -> categories_desc}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('assets_running_num') }}" name="assets_running_num" required placeholder="Enter running number">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('assets_serial_num') }}" name="assets_serial_num" required placeholder="Enter serial number">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="assets_location_id" required>
                                                ...
                                                @foreach ($getLocation as $locations)
                                                    <option value="{{ $locations->idlocations }}">{{ $locations->locations_name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('assets_PO_num') }}" name="assets_PO_num" placeholder="Enter PO number">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{ old('assets_handover_date') }}" name="assets_handover_date" placeholder="Enter handover date">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('assets_purchase_cost') }}" name="assets_purchase_cost" placeholder="Enter purchase price">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{ old('assets_purchase_date') }}" name="assets_purchase_date" placeholder="Enter purchase date">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" value="{{ old('assets_vendor_id') }}" name="assets_vendor_id" required>
                                                ...
                                                @foreach($getVendor as $vendor)
                                                    <option value="{{ $vendor->idvendors }}">{{ $vendor->vendors_name }}</option>
                                                @endforeach
                                            </select>
                                            <span class="text-danger">{{ $errors->first('assets_vendor_id') }}</span>
                                        </div>
                                </div>
                            </div>
                            <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{ old('assets_warranty_expiry') }}" name="assets_warranty_expiry" placeholder="Enter expiry warranty date">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" value="{{ old('assets_status_id') }}" name="assets_status_id" required>
                                                ...
                                                @foreach($getStatus as $status)
                                                    <option value="{{ $status->idstatus }}">{{ $status->status_type }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="assets_supporting_doc">Attachment (Optional)</label>
                                            <input type="file" class="form-control" name="assets_supporting_doc" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,png,jpg,jpeg" >
                                            <span class="text-danger">{{ $errors->first('assets_supporting_doc') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>                                                                                                                                                                                                                                                                                                                              
