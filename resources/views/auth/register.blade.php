...
<head>
    ...
    <title>Register - ICT AssetsMS.com</title>
        ...
        <div class="row justify-content-center align-items-center min-vh-100">
            <div class="col-md-8">
                <div class="auth-card">
                    ...
                    <h1 class="auth-title text-center mb-4">Register an Account</h1>
                    ...
                    <form action="{{ url('/auth/register') }}" method="post">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="name" class="form-control form-control-xl" placeholder="Name" required>
                            <div class="form-control-icon">
                                <i class="bi bi-person-fill"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="staff_num" class="form-control form-control-xl" placeholder="Staff Number" required>
                            <div class="form-control-icon">
                                <i class="bi bi-person-badge-fill"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="department" class="form-control form-control-xl" placeholder="Department" required>
                            <div class="form-control-icon">
                                <i class="bi bi-building"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="branch" class="form-control form-control-xl" placeholder="Branch" required>
                            <div class="form-control-icon">
                                <i class="bi bi-diagram-3-fill"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="tel" name="phone_num" class="form-control form-control-xl" placeholder="Phone Number" required>
                            <div class="form-control-icon">
                                <i class="bi bi-telephone-fill"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <select class="form-control form-control-xl" value="{{ old('user_role_id') }}" name="user_role_id" required>
                            <option value="">Select User Role</option>
                                 @foreach($getUserRole as $role)
                                    <option value="{{ $role->id }}">{{ $role->gp_name }}</option>
                                 @endforeach
                            </select>
                            <div class="form-control-icon">
                        ...
                        <input type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-2 w-100" name="submit" value="Register" required>
                    </form>
                    
                    <div class="text-center mt-4">
                        <p class="fs-5"> <a class="font-bold" href="{{ url('/auth/userlist') }}">Back</a></p>
                    </div>
                </div>
            </div>
        </div>
