...
<div class="page-heading">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Edit assets disposal here.</p>
                        </div>
                ...
                <form action="{{ url('/disposal/edit/'.$getRecord->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="row"> 
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="disposal_date" value="{{ old('disposal_date', $getRecord->disposal_date) }}" name="disposal_date" required placeholder="Enter disposal date"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="disposal_reason" value="{{ old('disposal_reason', $getRecord->disposal_reason) }}" name="disposal_reason" required placeholder="Enter disposal reason">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="disposal_method" value="{{ old('disposal_method', $getRecord->disposal_method) }}" name="disposal_method" required placeholder="Enter disposal method">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="support_doc">Supporting document<span class="text-danger">*</span></label>
                                            @if($getRecord->support_doc)
                                                <p>
                                                    Current file:
                                                    <a href="{{ asset('upload/disposal_docs/' . $getRecord->support_doc) }}" target="_blank">
                                                        View / Download File
                                                    </a>
                                                </p>
                                            @endif
                                            <input type="file" class="form-control" id="support_doc" name="support_doc" placeholder="Enter supporting document">
